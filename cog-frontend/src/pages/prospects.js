                            ...
                            <div className="px-10 py-5 grid grid-cols-2 gap-x-10">
                                <div>
                                    <div className="max-w-[30rem] text-center pt-20 text-[#4B4B4B]">
                                        <h1 className='font-bold mb-10'>You have no previous income statement</h1>
                                        <p>Sign up for the standard plan to get monthly income statements</p>
                                        <p>Go to settings &gt; subscriptions to begin.</p>
                                    </div>
                                </div>
                                <figure>
